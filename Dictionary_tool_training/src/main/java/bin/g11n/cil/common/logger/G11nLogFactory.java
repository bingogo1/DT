...
/**
 * <p>Factory for creating {@link ILogger} instances.
 */

public abstract class G11nLogFactory {
    ...
    /**
     * The property 
     * used to identify the G11nLogFactory implementation
     * class name. This can be used as a system property, or as an entry in a
     * configuration properties file.
     */
    public static final String FACTORY_PROPERTY = "factory.impl.class";

    /**
     * The fully qualified class name of the fallback <code>G11nLogFactory</code>
     * implementation class to use, if no other can be found.
     */
    public static final String FACTORY_DEFAULT =
        "bin.g11n.cil.common.logger.impl.G11nLogFactoryImpl";

    /**
     * The name of the customized properties file to search for.
     * This properties file will be copied to the user of cil for configuration the logger.
     */
    public static final String FACTORY_PROPERTIES =
        "cil_global_logging.properties";

    /**
     * The name of the cil default properties file to search for.
     */
    public static final String FACTORY_DEFAULT_PROPERTIES =
        "com/hp/g11n/cil/global_default_logging.properties";
    ...
    protected static final String SERVICE_ID =
        "META-INF/services/bin.g11n.cil.common.logger.G11nLogFactory";

    /**
     * Theproperty used to enable internal g11n_logging
    ...
    public static final String DIAGNOSTICS_DEST_PROPERTY =
        "bin.g11n.cil.common.logger.diagnostics.dest";

    /**
     * When null (the usual case), no diagnostic output will be
     * generated by G11nLogFactory or G11nLogFactoryImpl. When non-null,
     ...
     * G11nLogFactory class is generating the output.
     */
    private static String diagnosticPrefix;
    
    /**
     * <p>Setting this system property 
     * (<code>HashtableImpl</code>) 
     * value allows the <code>Hashtable</code> used to store
     * classloaders to be substituted by an alternative implementation.
     * </p>
     * <p>
     * <strong>Note:</strong> <code>G11nLogFactory</code> will print:
     * <code><pre>
     * [ERROR] G11nLogFactory: Load of custom hashtable failed</em>
     * </pre></code>
     * to system error and then continue using a standard Hashtable.
     * </p>
     * <p>
     * <strong>Usage:</strong> Set this property when Java is invoked
     * and <code>G11nLogFactory</code> will attempt to load a new instance 
     ...
     *     &lt;sysproperty 
     *        key="HashtableImpl"
     *        value="bin.g11n.cil.common.logger.AltHashtable"/&gt;
     *  &lt;/java&gt;
     * </pre></code>
     * will mean that <code>G11nLogFactory</code> will load an instance of
     * <code>bin.g11n.cil.common.logger.AltHashtable</code>.
     * </p>
     * <p>
    ...
    private static final String WEAK_HASHTABLE_CLASSNAME = 
        "bin.g11n.cil.common.logger.impl.WeakHashtable";

    /**
     * A reference to the classloader that loaded this class. This is the
     * same as G11nLogFactory.class.getClassLoader(). However computing this
     ...
     */
    public abstract ILogger getInstance(Class clazz)
    ...
    /**
     * Release any internal references to previously created {@link ILogger}
    ...
    /**
     * The previously constructed <code>G11nLogFactory</code> instances, keyed by
     * the <code>ClassLoader</code> with which it was created.
     */
    protected static Hashtable factories = null;
    
    /**
     * Prevously constructed <code>G11nLogFactory</code> instance as in the
     ...
     */
    protected static G11nLogFactory nullClassLoaderFactory = null;

    /**
     * Create the hashtable which will be used to store a map of
     * (context-classloader -> G11nLogFactory-object). Version 1.2+ of Java
     ...
     * that G11nLogFactory.release(contextClassLoader) is called whenever a 
        ...
        try {
            ...
            if (!WEAK_HASHTABLE_CLASSNAME.equals(storeImplementationClass)) {
                ...
                if (isDiagnosticsEnabled()) {
                    ...
                    logDiagnostic("[ERROR] G11nLogFactory: Load of custom hashtable failed");
                } else {
                    // we *really* want this output, even if diagnostics weren't
                    // explicitly enabled by the user.
                    System.err.println("[ERROR] G11nLogFactory: Load of custom hashtable failed");
                }
            }
        }
        if (result == null) {
    ...
    /**
     * <p>Construct (if necessary) and return a <code>G11nLogFactory</code>
     * instance, using the following ordered lookup procedure to determine
     * the name of the implementation class to be loaded.</p>
     * <ul>
     * <li>The <code>bin.g11n.cil.common.logger.G11nLogFactory</code> system
     *     property.</li>
     * <li>The JDK 1.3 Service Discovery mechanism</li>
     * <li>Use the properties file <code>g11n_logging.properties</code>
     *     file, if found in the class path of this class.  The configuration
     *     file is in standard <code>java.util.Properties</code> format and
     *     contains the fully qualified name of the implementation class
     *     with the key being the system property defined above.</li>
     * <li>Fall back to a default implementation class
     *     (<code>bin.g11n.cil.common.logger.impl.G11nLogFactoryImpl</code>).</li>
     * </ul>
     *
     * <p><em>NOTE</em> - If the properties file method of identifying the
     * <code>G11nLogFactory</code> implementation class is utilized, all of the
     * properties defined in this file will be set as configuration attributes
     * on the corresponding <code>G11nLogFactory</code> instance.</p>
     * 
     ...
     */
    public static G11nLogFactory getFactory() throws LogConfigurationException {
        ...
        G11nLogFactory factory = getCachedFactory(contextClassLoader);
        if (factory != null) {
            return factory;
        }
        ...
        if (isDiagnosticsEnabled()) {
            logDiagnostic(
                    "[LOOKUP] G11nLogFactory implementation requested for the first time for context classloader "
        ...
        // "attributes" on the G11nLogFactory implementation class. One particular
        // property may also control which G11nLogFactory concrete subclass is
        // used, but only if other discovery mechanisms fail..
        //
        // As the properties file (if it exists) will be used one way or 
        // another in the end we may as well look for it first.

        Properties props = getConfigurationFile(contextClassLoader, FACTORY_PROPERTIES, FACTORY_DEFAULT_PROPERTIES);
        ...
        if (props != null) {
            ...
            if (useTCCLStr != null) {
                ...
                if (Boolean.valueOf(useTCCLStr).booleanValue() == false) {
                    ...
                    // G11nLogFactory or ILogger classes, just use the class that loaded
        ...
        // Determine which concrete G11nLogFactory subclass to use.
        // First, try a global system property
        if (isDiagnosticsEnabled()) {
            logDiagnostic(
                    "[LOOKUP] Looking for system property [" + FACTORY_PROPERTY 
                    + "] to define the G11nLogFactory subclass to use...");
        }
        ...
        try {
            ...
            if (factoryClass != null) {
                if (isDiagnosticsEnabled()) {
                    logDiagnostic(
                            "[LOOKUP] Creating an instance of G11nLogFactory class '" + factoryClass
            ...
            // This is not consistent with the behaviour when a bad G11nLogFactory class is
            // specified in a services file.
            //
            // One possible exception that can occur here is a ClassCastException when
            // the specified class wasn't castable to this G11nLogFactory type.
            if (isDiagnosticsEnabled()) {
                logDiagnostic(
            ...
            try {
                ...
                if( is != null ) {
                    ...
                    if (factoryClassName != null &&
                        ...
                        if (isDiagnosticsEnabled()) {
                            logDiagnostic(
                                    "[LOOKUP]  Creating an instance of G11nLogFactory class " + factoryClassName
                ...
                // note: if the specified G11nLogFactory class wasn't compatible with G11nLogFactory
        ...
        if (factory == null) {
            if (props != null) {
                ...
                if (factoryClass != null) {
                    if (isDiagnosticsEnabled()) {
                        logDiagnostic(
                            "[LOOKUP] Properties file specifies G11nLogFactory subclass '" 
                            + factoryClass + "'");
                    }
                    factory = newFactory(factoryClass, baseClassLoader, contextClassLoader);
                    ...
                    if (isDiagnosticsEnabled()) {
                        logDiagnostic(
                            "[LOOKUP] Properties file has no entry specifying G11nLogFactory subclass.");
                    }
                }
            } else {
                if (isDiagnosticsEnabled()) {
        ...
        if (factory == null) {
            if (isDiagnosticsEnabled()) {
                logDiagnostic(
                "[LOOKUP] Loading the default G11nLogFactory implementation '" + FACTORY_DEFAULT
                + "' via the same classloader that loaded this G11nLogFactory"
                + " class (ie not looking in the context classloader).");
            }
            
            // Note: unlike the above code which can try to load custom G11nLogFactory
            // implementations via the TCCL, we don't try to load the default G11nLogFactory
            // implementation via the context classloader because:
            // * that can cause problems (see comments in newFactory method)
            // * no-one should be customising the code of the default class
            // Yes, we do give up the ability for the child to ship a newer
            // version of the G11nLogFactoryImpl class and have it used dynamically
            // by an old G11nLogFactory class in the parent, but that isn't 
     ...
     *  instance cannot be returned
     */
    public static ILogger getLog(Class clazz)
        throws LogConfigurationException {
    ...
    /**
     * Release any internal references to previously created {@link G11nLogFactory}
     * instances that have been associated with the specified class loader
     * (if any), after calling the instance method <code>release()</code> on
     * each of them.
     *
     * @param classLoader ClassLoader for which to release the G11nLogFactory
     */
    public static void release(ClassLoader classLoader) {
        ...
        synchronized (factories) {
            if (classLoader == null) {
                ...
                G11nLogFactory factory = (G11nLogFactory) factories.get(classLoader);
                if (factory != null) {
                    factory.release();
    ...
    public static void releaseAll() {
        ...
        synchronized (factories) {
            ...
            while (elements.hasMoreElements()) {
                G11nLogFactory element = (G11nLogFactory) elements.nextElement();
                element.release();
            }
            factories.clear();
     ...
     * throw SecurityException. g11n_logging basically relies on the
     * ability to access classloaders, ie a policy that forbids all
     * classloader access will also prevent g11n_logging from working: 
     * currently this method will throw an exception preventing the entire app
     * from starting up. Maybe it would be good to detect this situation and
     * just disable all g11n_logging? Not high priority though - as stated
     ...
     * this method is called every time G11nLogFactory.getLogger() is called,
        ...
        throws LogConfigurationException
    {
        ...
        try {
            ...
            classLoader = getClassLoader(G11nLogFactory.class);

            // We deliberately don't log a message here to outputStream;
            // this message would be output for every call to G11nLogFactory.getLog()
            ...
            //         + " the concrete G11nLogFactory class.");
            // }
     ...
     * with the current thread. This allows separate G11nLogFactory objects
     ...
     */
    private static G11nLogFactory getCachedFactory(ClassLoader contextClassLoader)
    {
        G11nLogFactory factory = null;
        ...
        if (contextClassLoader == null) {
            ...
            factory = (G11nLogFactory) factories.get(contextClassLoader);
        }
    ...
    /**
     * Remember this factory, so later calls to G11nLogFactory.getCachedFactory
     * can return the previously created object (together with all its
     * cached ILogger objects).
     *
     ...
     */
    private static void cacheFactory(ClassLoader classLoader, G11nLogFactory factory)
    {
    ...
    /**
     * Return a new instance of the specified <code>G11nLogFactory</code>
     * implementation class, loaded by the specified class loader.
     * If that fails, try the class loader used to load this
     * (abstract) G11nLogFactory.
     * 
     * @param factoryClass Fully qualified name of the <code>G11nLogFactory</code>
     ...
     * @since 1.1
     */
    protected static G11nLogFactory newFactory(final String factoryClass,
     ...
     * G11nLogFactory.getFactory, any custom definition in a subclass would be
     ...
     * 
     * @return either a G11nLogFactory object or a LogConfigurationException object.
     * @since 1.1
     */
        ...
        try {
            if (classLoader != null) {
                try {
                    ...
                    if (G11nLogFactory.class.isAssignableFrom(logFactoryClass)) {
                        if (isDiagnosticsEnabled()) {
                            logDiagnostic(
                        ...
                        if (isDiagnosticsEnabled()) {
                            logDiagnostic(
                                ...
                                + " does not extend '" + G11nLogFactory.class.getName()
                                + "' as loaded by this classloader.");
                            logHierarchy("[BAD CL TREE] ", classLoader);
                        }
                    }
                    
                    return (G11nLogFactory) logFactoryClass.newInstance();
                    ...
                    if (classLoader == thisClassLoader) {
                        ...
                        // 
                        String msg = 
                            "The application has specified that a custom G11nLogFactory implementation should be used but " +
                            "Class '" + factoryClass + "' cannot be converted to '"
                            + G11nLogFactory.class.getName() + "'. ";
                        if (implementsLogFactory) {
                            msg = msg + "The conflict is caused by the presence of multiple G11nLogFactory classes in incompatible classloaders. ";
                        } else {
             ...
             * to G11nLogFactory.class.getClassLoader().load(name), ie we ignore
             ...
             *
             * Notes:
             * * G11nLogFactory.class.getClassLoader() may return 'null'
             *   if G11nLogFactory is loaded by the bootstrap classloader.
             */
            // Warning: must typecast here & allow exception
            // to be generated/caught & recast properly.
            if (isDiagnosticsEnabled()) {
                logDiagnostic(
                    ...
                    + " - trying the classloader associated with this G11nLogFactory.");
            }
            ...
            if (isDiagnosticsEnabled()) {
                logDiagnostic("Unable to create G11nLogFactory instance.");
            }
            if (logFactoryClass != null
                && !G11nLogFactory.class.isAssignableFrom(logFactoryClass)) {
                
                return new LogConfigurationException(
                    "The chosen G11nLogFactory implementation does not extend G11nLogFactory."
    ...
    /**
     * Determines whether the given class actually implements <code>G11nLogFactory</code>.
     ...
     * the <code>G11nLogFactory</code> class loaded by the class's classloader.
     * @param logFactoryClass <code>Class</code> which may implement <code>G11nLogFactory</code>
     * @return true if the <code>logFactoryClass</code> does extend
     * <code>G11nLogFactory</code> when that class is loaded via the same
            ...
            try {
                ...
                if (logFactoryClassLoader == null) {
                    ...
                    Class factoryFromCustomLoader
                        = Class.forName("bin.g11n.cil.common.logger.G11nLogFactory", false, logFactoryClassLoader);
                    implementsLogFactory = factoryFromCustomLoader.isAssignableFrom(logFactoryClass);
                    if (implementsLogFactory) {
                        logDiagnostic("[CUSTOM LOG FACTORY] " + logFactoryClass.getName()
                                + " implements G11nLogFactory but was loaded by an incompatible classloader.");
                    } else {
                        logDiagnostic("[CUSTOM LOG FACTORY] " + logFactoryClass.getName()
                                + " does not implement G11nLogFactory.");
                    }
                }
            } catch (SecurityException e) {
                //
                ...
                //
                // G11nLogFactory cannot be loaded by the classloader which loaded the custom factory implementation.
                ...
                //
                logDiagnostic("[CUSTOM LOG FACTORY] G11nLogFactory class cannot be loaded by classloader which loaded the " +
                        "custom G11nLogFactory implementation. Is the custom factory in the right classloader?");
            }
        }
     ...
     * a secure operation, but where the g11n_logging library has explicitly
     ...
     * override logging settings in all webapps by placing a g11n_logging.properties
     * file in a shared classpath location with a priority > 0; this overrides any
     * g11n_logging.properties files without priorities which are in the
    ...
    private static final Properties getConfigurationFile(
            ClassLoader classLoader, String userFileName, String defaultFileName) {
        ...
        URL url = null;
        try {
            Enumeration urls = getResources(classLoader, userFileName);
            if (!urls.hasMoreElements()){
            	//try to find user defined configuration in root of classpath.
            	try{
            		File propFile = new File(userFileName);
            		...
            		if (propFile.exists()) {
            			...
            			propsUrl = propFile.toURL();
            			props = getProperties(propsUrl);
            			if (props != null){
                ...
                //If can not get customized configuration file, get cil default configuration file insteadly.
            	urls = getResources(classLoader, defaultFileName);
            }
    ...
    private static void initDiagnostics() {
        ...
        // [G11nLogFactory from classloader OID]
        //
        // Note that this prefix should be kept consistent with that 
        // in G11nLogFactoryImpl. However here we don't need to output info
        // about the actual *instance* of G11nLogFactory, as all methods that
        ...
        diagnosticPrefix = "[G11nLogFactory from " + classLoaderName + "] ";
    }
     ...
     * method puts in front of all its messages is G11nLogFactory@....,
    ...
    // G11nLogFactory instances are created, and they depend upon this
    ...
    static {
        ...
        thisClassLoader = getClassLoader(G11nLogFactory.class);
        initDiagnostics();
        logClassLoaderEnvironment(G11nLogFactory.class);
