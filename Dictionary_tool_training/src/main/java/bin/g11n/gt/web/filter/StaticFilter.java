...
/**
 * A simple filter that allows the application to continue using the .action prefix for actions but also allows
 ...
 * servlet. All Dojo related .action requests are allowed to pass straight through to be processed by the servlet
...
public class StaticFilter extends OncePerRequestFilter {
    private final static String DEFAULT_INCLUDES = "*.action";
